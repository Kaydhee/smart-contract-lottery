...
contract RaffleTest is CodeConstants, Test {
    ...
    function testPerformUpkeepCanOnlyRunIfChceckUpkeepIsTrue() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testPeformUpKeepUpdatesRaffleStateAndEmitsRequestId() public raffleEntered {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaffle{value: entranceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testFulfillrandomWordsPicksAWinnerResetsAndSendMoney() public raffleEntered skipFork {
        ...
        uint256 startingTimeStap = raffle.getLastTimeStamp();
